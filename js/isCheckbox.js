// 모든 체크박스 선택
let checkboxes = document.getElementsByName("isChecked");
...
function selectLine() {
    for (let i = 0; i < ev_material.length * 2; i++) {
        console.log(i + " : " + checkboxes[i]);
        if (checkboxes[i].checked) {
            if (i % 2 == 0) {
                console.log("홀수");
                console.log(i / 2);
                ev_material[i / 2].style.backgroundColor = "#EDF7F6 !important";
            }
            else {
                console.log("짝");
            ...
            if (i % 2 == 0) {
                console.log("홀수");
                ev_material[i / 2].style.backgroundColor = "#ffffff";
            }
            else {
                console.log("짝");
